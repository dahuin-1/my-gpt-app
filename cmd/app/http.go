...
func handleHTTPServer(ctx context.Context, u *url.URL, commonEndpoints *common.Endpoints, appEndpoints *app.Endpoints, wg *sync.WaitGroup, errc chan error, logger *log.Logger, debug bool) {
